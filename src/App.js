...
const App = () => {
    ...
    const selectedRepos = [
        'IPL_analytics', 'MiniProjectThree', 'pythonprojects', 'Codementor-webScrapper', 'tailwindCards', 'noteTakingApp', 'CodeClause_Voice_Assistant_using_Python', 'CodeClause_AlarmClock_with_GUI', 'CodeClause_URL_Shortener_in_python', 'DiceGame', 'FoodDelivery-SIte','aircanvas','RestrauntManagementPython','ScannerApp'
